    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('user', 'Пользователь'), ('admin', 'Администратор'), ('moderator', 'Модератор')], default='member', max_length=16, verbose_name='Группа')),
                ('age', models.PositiveIntegerField(null=True, verbose_name='Возраст')),
                ('birth_date', models.DateField(max_length=10, validators=[service.models.birth_date_validator], verbose_name='Дата рождения')),
